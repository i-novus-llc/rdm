...
class GetLastRevisionJob extends AbstractEsnsiDictionaryProcessingJob {
    ...
    boolean execute0(JobExecutionContext context) throws Exception {
        ...
        Map.Entry<GetClassifierRevisionListResponseType, InputStream> getClassifierRevisionList = adapterClient.getResponse(messageId, GetClassifierRevisionListResponseType.class);
