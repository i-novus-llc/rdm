...
public class UnversionedAfterUpdateProcessReferrersStrategy implements Strategy {
    ...
    public void apply(RefBookVersionEntity entity,
        ...
        afterAddProcessReferrersStrategy.apply(entity, addedRowValues);
    ...
    private void processReferrers(RefBookVersionEntity entity,
        ...
        final List<RowValue> deletedRowValues = oldReferredRowValues.entrySet().stream()
                ...
                .collect(toList());
        beforeDeleteProcessReferrersStrategy.processReferrers(entity, primaries, deletedRowValues);
        ...
        final List<RowValue> addedRowValues = newReferredRowValues.entrySet().stream()
                ...
                .map(Map.Entry::getValue)
                .collect(toList());
        afterAddProcessReferrersStrategy.processReferrers(entity, primaries, addedRowValues);
    }

    private void processReferrers(RefBookVersionEntity entity,
                                  List<Structure.Attribute> primaries,
                                  Map<String, RowValue> oldRowValues,
                                  Map<String, RowValue> newRowValues) {
