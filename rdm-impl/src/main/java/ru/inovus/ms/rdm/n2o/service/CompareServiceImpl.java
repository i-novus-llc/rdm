...
import ru.inovus.ms.rdm.n2o.model.diff.DiffRowValuePage;
...
import ru.inovus.ms.rdm.n2o.model.diff.PassportAttributeDiff;
import ru.inovus.ms.rdm.n2o.model.diff.PassportDiff;
...
import static ru.inovus.ms.rdm.n2o.util.ComparableUtils.*;
import static ru.inovus.ms.rdm.n2o.util.ConverterUtil.getFieldSearchCriteriaList;
...
public class CompareServiceImpl implements CompareService {
    ...
    @Override
    @Transactional(readOnly = true)
    public RefBookDataDiff compareData(ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria criteria) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<ComparableRow> getCommonComparableRows(ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria criteria) {
    ...
    private CompareDataCriteria createVdsCompareDataCriteria(RefBookVersionEntity oldVersion, RefBookVersionEntity newVersion,
                                                             ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria rdmCriteria) {
    ...
    private ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria createVdsCompareDataCriteria(CompareCriteria criteria, Page<? extends RowValue> data, Structure structure) {
        ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria rdmCriteria = new ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria(criteria);
        rdmCriteria.setPrimaryAttributesFilters(createPrimaryAttributesFilters(data, structure));
        return rdmCriteria;
    }

    private ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria createRdmCompareDataCriteriaDeleted(CompareCriteria criteria) {
        ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria deletedRdmCriteria = new ru.inovus.ms.rdm.n2o.model.compare.CompareDataCriteria(criteria);
