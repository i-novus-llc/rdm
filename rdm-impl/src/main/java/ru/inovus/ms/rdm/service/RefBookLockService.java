...
@Service
public class RefBookLockService {

    private static final Logger logger = LoggerFactory.getLogger(RefBookLockService.class);
    ...
    @Autowired
    public RefBookLockService(RefBookRepository refBookRepository, RefBookOperationRepository operationRepository,
