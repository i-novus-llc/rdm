...
public class RequiredValueValidationTest {
    ...
    public void testValidate() throws Exception {
        ...
        Message expected1_1 = new Message(PkRequiredValidation.VALIDATION_REQUIRED_PK_ERR_EXCEPTION_CODE, PRIMARY);
        ...
        Message expected2_1 = new Message(PkRequiredValidation.VALIDATION_REQUIRED_PK_ERR_EXCEPTION_CODE, PRIMARY);
        assertTrue(messages2.contains(expected2_1));
        Message expected2_3 = new Message(PkRequiredValidation.VALIDATION_REQUIRED_PK_ERR_EXCEPTION_CODE, IGNORED_PRIMARY);
