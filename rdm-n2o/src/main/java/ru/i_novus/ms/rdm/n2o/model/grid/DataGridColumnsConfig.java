...
public class DataGridColumnsConfig {
    ...
    @JsonProperty
    private final List<SimpleColumn> headers;

    @JsonProperty
    private final List<AbstractCell> cells;

    public static SimpleColumn createHeader(String id, String label, StandardField<Control> filterField) {

        return createHeader(id, label, filterField != null, true, true, filterField);
    }

    public static SimpleColumn createHeader(String id, String label,
    ...
    public static SimpleColumn createHeader(String id, String label, String src,
                                            boolean filterable, boolean resizable, String sortingParam,
                                            StandardField<Control> filterField) {

        final SimpleColumn header = new SimpleColumn();
        header.setId(id);
        ...
        header.setVisible(Boolean.TRUE);
        header.setVisibleState(Boolean.TRUE);
